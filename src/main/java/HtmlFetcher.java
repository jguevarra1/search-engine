...
public class HtmlFetcher {
	...
	public static boolean isHtml(Map<String, List<String>> headers)
	{
		...
		{
			return headers.get(header).get(0).startsWith("text/html");
		}
	...
	public static boolean isRedirect(Map<String, List<String>> headers)
	{
		...
		boolean checkRedirect = (statusCode > 300) && (statusCode <= 399);
		boolean hasLocationHeader = headers.containsKey("Location") && !headers.get("Location").isEmpty();

		return hasLocationHeader && checkRedirect;
	}
