...
public class HtmlCleaner {
	...
	{		
		String regex = "(?i)(?s)(<\\b" + name + "\\b>?.*?</" + name + "\\s*?>)"; // use name opening and closing

		return html.replaceAll(regex, "");	// 2 parts match first tag 
											// second part match other tag 3rd part not a greedy in middle
	}
